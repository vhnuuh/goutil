...
func main() {
	...
	retryErr := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		...
		if getErr != nil {
			panic(fmt.Errorf("failed to get latest"))
		}
		...
		if err := unstructured.SetNestedField(containers[0].(map[string]interface{}), "nginx:1.3", "image"); err != nil {
			panic(err)
		}
	...
	for _, d := range list.Items {
		replics, found, err := unstructured.NestedInt64(d.Object, "spec", "replicas")
		if err != nil || !found {
